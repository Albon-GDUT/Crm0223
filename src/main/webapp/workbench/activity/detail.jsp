			...
			$.ajax({
				...
				success : function (data) {
					...
					if(data.success){
						...
						html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #037cff;"></span></a>';
						html += '&nbsp;&nbsp;&nbsp;&nbsp;';
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data, function (i,n) {
					...
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
					html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\''+n.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #037cff;"></span></a>';
					html += '&nbsp;&nbsp;&nbsp;&nbsp;';
